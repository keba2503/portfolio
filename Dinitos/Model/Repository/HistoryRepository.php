...
use Hiperdino\Dinitos\Api\HistoryRepositoryInterface;
...
{
    protected HistoryFactory $objectFactory;
     ...
     * @throws CouldNotDeleteException
     */
    public function delete(HistoryInterface $object): bool
    {
        try {
            $object->delete();
